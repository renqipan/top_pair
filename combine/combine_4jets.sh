...
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=60 --alignEdges=1 -P y --floatOtherPOIs=1 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_y -v 3 -m 125 --setParameterRanges y=-2.0,2.0:x=0.0,0.0 --saveInactivePOI=1
