...
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=60 --alignEdges=1 -P y --floatOtherPOIs=0 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_y_fix -v 3 -m 125 --setParameterRanges y=-2.0,2.0 --saveInactivePOI=1
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=60 --alignEdges=1 -P z --floatOtherPOIs=0 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_z_fix -v 3 -m 125 --setParameterRanges z=-1.0,3.0 --saveInactivePOI=1
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=60 --alignEdges=1 -P k --floatOtherPOIs=0 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_k_fix -v 3 -m 125 --setParameterRanges k=-2.0,2.0 --saveInactivePOI=1
...
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=3600 --alignEdges=1  -P k -P y --floatOtherPOIs=0 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_2Dyk_fix -v 3 -m 125 --setParameterRanges y=-2.0,2.0:k=-2.0,2.0 --saveInactivePOI=1
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=3600 --alignEdges=1  -P z -P k --floatOtherPOIs=0 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_2Dzk_fix -v 3 -m 125 --setParameterRanges z=-1.0,3.0:k=-2.0,2.0 --saveInactivePOI=1
combine -M MultiDimFit workspace_ttbar_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=3600 --alignEdges=1  -P y -P z --floatOtherPOIs=0 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_2Dyz_fix -v 3 -m 125 --setParameterRanges y=-2.0,2.0:z=-1.0,3.0 --saveInactivePOI=1

combine -M MultiDimFit workspace_ttbar_4jets_fcp.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=60 --alignEdges=1 -P fcp --floatOtherPOIs=1 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_4jets_fcp -v 3 -m 125 --setParameterRanges fcp=-1.0,1.0:y=0.0,0.0 --saveInactivePOI=1
