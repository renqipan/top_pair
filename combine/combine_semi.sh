...
combine -M MultiDimFit workspace_ttbar_semi_fcp.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=40 --alignEdges=1 -P fcp --floatOtherPOIs=1 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_semi_fcp -v 3 -m 125 --setParameterRanges fcp=-1.0,1.0:y=0.0,0.0 --saveInactivePOI=1
