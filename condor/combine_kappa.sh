...
text2workspace.py ttbar_kappa_4jets.txt -o workspace_ttbar_kappa_4jets.root --PO doStage0 --PO doacttbar -P HiggsAnalysis.CombinedLimit.stagex_ttsyk:stagex_ttsyk -m 125 --X-allow-no-background  -v 7  
...
#combine -M MultiDimFit workspace_ttbar_kappa_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=3600 --alignEdges=1  -P kappa -P kappa_t --floatOtherPOIs=1 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_kappa_4jets_2Dyk -v 3 -m 125 --setParameterRanges kappa=-2.0,2.0:k=-2.0,2.0:z=0.0,0.0 --saveInactivePOI=1 --trackParameters sig_norm,bkg_norm 
combine -M MultiDimFit workspace_ttbar_kappa_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=3600 --alignEdges=1  -P kappa -P kappa_t --floatOtherPOIs=1 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_kappa_4jets_2Dzk -v 3 -m 125 --setParameterRanges kappa=-2.0,2.0:kappa_t=-3.5,3.5 --saveInactivePOI=1 --trackParameters sig_norm,bkg_norm
#combine -M MultiDimFit workspace_ttbar_kappa_4jets.root -S 1 -t -1 --expectSignal=1 --algo=grid --points=3600 --alignEdges=1  -P kappa -P kappa_t --floatOtherPOIs=1 --X-rtd TMCSO_AdaptivePseudoAsimov=10 -n ttbar_kappa_4jets_2Dyz -v 3 -m 125 --setParameterRanges y=-2.0,2.0:z=-1.0,3.0:k=0.0,0.0 --saveInactivePOI=1 --trackParameters sig_norm,bkg_norm
