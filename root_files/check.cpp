...
void check() {
  ...
  Int_t Jet_partonFlavour[35], Muon_charge[9], Electron_charge[8],
      lepton_charge[17];
  ...
  mytree->Branch("jet_num", &jet_num,
                 "jet_num/I"); // number of jets satisfy the  seletion criteria
  ...
  cout << "infomation is writing. Please wait for a while" << endl;
  Int_t njet_need =
      4; // the at least number of jet of semileptonic final satate
