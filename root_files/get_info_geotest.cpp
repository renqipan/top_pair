...
TH1F* get_hist_fromFile(TString fileName){
	TFile file_1D(fileName,"read");
	TCanvas *c2 = (TCanvas*)file_1D.Get("c2");
	TH1F *h1= (TH1F*)c2->GetListOfPrimitives()->FindObject("h1");
	Floor(h1);
	return h1;
...
Double_t likelihood(TLorentzVector neup,Double_t *pars){
   ...
   // pro_tlep=ROOT::Math::gaussian_pdf(mass_tlep,sigmat_lep,mt_lep);
    ...
    if(minD>=0){
		...
		log_nupz=-TMath::Log(pro_mthad_right/pro_mthad_wrong)-TMath::Log(pro_mwhad_right/pro_mwhad_wrong)-TMath::Log(pro_D);
	}
	else{
		log_nupz=1000000;
	}
...
void get_info_geotest(){
    ...
    //////////////////////////////////////////////////////////////
    h1_mthad_right=get_hist_fromFile("massthad_right.root");
	h1_mthad_wrong=get_hist_fromFile("massthad_wrong.root");
	h1_mwhad_right=get_hist_fromFile("masswhad_right.root");
	h1_mwhad_wrong=get_hist_fromFile("masswhad_wrong.root");
	////////////////////////////////////////////////////////////
